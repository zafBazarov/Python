...
So there are a few common tools and libraries in Python to build data visualizations. In this course, we're going to utilize the Anaconda Python distribution, and second, I encourage you to use Jupyter Notebooks. 
...
So as far as why we use the Anaconda Python distribution, Python has a solid claim to be the fastest-growing major programming language, and Anaconda is the strongly recommended way of installing Jupyter Notebooks.
So what Anaconda is really is a package manager, an environment manager, and Python distribution. Think of it as kind of like an app store for Python. Data visualization projects require many different packages and libraries. 
What's great is that Anaconda comes pre-installed with many of them. So what about Jupyter? Jupyter Notebooks contain both code and rich text elements, such as visualizations, links, and equations. 
So right here is a Jupyter Notebook in action, and you'll see a lot of that throughout this course. So I want to quickly tell you about NumPy and Pandas. 
Before we can plot data, we first need data in a portable form. NumPy and Pandas can be used to efficiently load, store, manipulate, and export in memory data. 
